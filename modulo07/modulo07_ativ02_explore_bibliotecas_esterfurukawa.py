...
print(f' Usando Adição ({num1} + {num2}) :', utilidades.adicao(num1, num2))

print(f' Usando Subtrair ({num1} - {num2}) :', utilidades.subtrair(num1, num2))

print(f"Multiplicação ({num1} * {num2}):", utilidades.multiplicacao(num1, num2))

print(f"Divisão ({num1} / {num2}):", utilidades.divisao(num1, num2))
...
print(f"Potenciação ({num1} ^ {num2}):", utilidades.potenciacao(num1, num2))

print("\n=== TESTE DE SEGURANÇA (DIVISÃO POR ZERO) ===")
print("Divisão por zero:", utilidades.resto_divisao(10, 0))